      ...
      {health && !health.ready && (
        <div className="bg-red-500/15 border-b border-red-500/40 px-6 py-3 text-center text-sm text-red-200/95 flex flex-wrap items-center justify-center gap-2">
          ...
          {health.python.status === "error" && (
            <span>Python API kapalı. Yerel: <code className="bg-black/30 px-1 rounded">npm run dev:all</code>. Railway: <code className="bg-black/30 px-1 rounded">PYTHON_API_URL</code> ekle.</span>
          )}
          <button
            type="button"
